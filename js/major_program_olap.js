var major_program_olap = major_program_olap || {};

major_program_olap.onLoad = function(loadedGadgets, gadget) {
    ...
    var url4 = dsg_site_root + 'application/third_party/pivot/pivot.js';
    ...
    var url8 = dsg_site_root + 'application/third_party/pivot/export_renderers.js';
                    ...
                    requireScript('c3_renderers', 'always', url5, function() {
                        requireScript('tips-data', 'always', url6, function() {
                            requireScript('touch-punch', 'always', url7, function() {
                                requireScript('touch-punch', 'always', url8, function() {
                                    $('head').append(css1);
                                    $('head').append(css2);

                                    major_program_olap.gadget = gadget;
                                    var wId = "gadget_" + loadedGadgets.major_program_olap.gadgetId;
                                    var title = "portlet_title_" + loadedGadgets.major_program_olap.gadgetId;
                                    var jId = '#' + wId;
                                    ...
                                    $.get(dsg_site_root + 'getPage/olap', function(pageData) {
                                        ...
                                        $.get(dsg_site_root + "majorProgramCenter/getOLAPPrefs", function(data1) {
                                            ...
                                            if (!olapPrefs.MP_OLAP_prefs) {
                                                ...
                                                OLAPoptions = JSON.parse(olapPrefs.MP_OLAP_prefs);
                                            }
                                            ...
                                            $.ajax({
                                                url: dsg_site_root + "majorProgramCenter/mpOLAP/" + gadget.params[0] + "?api=json",
                                                type: 'GET',
                                                async: true,
                                                dataType: "json",
...
var reloadSelect = function(templates) {
...
var onRefresh = function(config) {
    ...
    $.ajax({
        type: "POST",
        url: dsg_site_root + "majorProgramCenter/saveOLAP/",
        data: sendData
    });
}
