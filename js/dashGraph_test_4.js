var dashGraph_test_4 = dashGraph_test_4 || {};




dashGraph_test_4.onLoad = function(loadedGadgets,gadget) {
	
	var comma0 = "[<0]#,#;[>0]#,#;-";

	dashGraph_test_4.gadget = gadget;
	var chart; 
	
	chart = anychart.column();

	var wId = "gadget_" + loadedGadgets.dashGraph_test_4.gadgetId;
	var jId = '#' + wId;
	$(jId).empty(); 
