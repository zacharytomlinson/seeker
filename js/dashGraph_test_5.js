var dashGraph_test_5 = dashGraph_test_5 || {};




dashGraph_test_5.onLoad = function(loadedGadgets,gadget) {
	
	var comma0 = "[<0]#,#;[>0]#,#;-";

	dashGraph_test_5.gadget = gadget;
	var chart; 
	
	chart = anychart.column();

	var wId = "gadget_" + loadedGadgets.dashGraph_test_5.gadgetId;
	var jId = '#' + wId;
	$(jId).empty(); 
