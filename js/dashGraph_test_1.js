var dashGraph_test_1 = dashGraph_test_1 || {};




dashGraph_test_1.onLoad = function(loadedGadgets,gadget) {

	var comma0 = "[<0]#,#;[>0]#,#;-";

	dashGraph_test_1.gadget = gadget;
	var chart;
	anychart.licenseKey(g_anychartLicenseKey);
	chart = anychart.column();

	var wId = "gadget_" + loadedGadgets.dashGraph_test_1.gadgetId;
	var jId = '#' + wId;
	$(jId).empty();
